...
namespace GrandLarceny
{
	...
	public class SpotLight : NonMovingObject
	{
			...
			base(a_position, a_sprite, a_layer)
		{
			...
			if (a_lit)
			{
				m_light = new LightCone(this, "Images//LightCone//Ljus", m_img.getSize().X, a_layer + 0.001f, 300f, 300f, a_layer - 0.01f, null);
		...
		public void toggleLight() {
			if (!m_turnedOffForEver)
			{
				...
				if (m_lit)
				{
					if (m_light == null)
					{
						m_light = new LightCone(this, "Images//LightCone//Ljus", m_img.getSize().X, m_layer + 0.001f, 300f, 300f, m_layer - 0.01f, null);
						Game.getInstance().getState().addObject(m_light);
						m_lightLink = m_light.getId();
					}
				}
